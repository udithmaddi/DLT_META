...
def onboard_dataflowspecs(args):
    ...
    if uc_enabled:
        ...
        if 'gold_dataflowspec_path' in onboarding_args_dict:
            del onboarding_args_dict['gold_dataflowspec_path']
    ...
    elif onboard_layer.lower() == "gold":
        onboard_obj.onboard_gold_dataflow_spec()
    elif onboard_layer.lower() == "bronze_silver_gold":
        onboard_obj.onboard_dataflow_specs()
    else:
